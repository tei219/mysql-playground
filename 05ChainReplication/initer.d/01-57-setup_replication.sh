...
if version 5.7.0 $mysql_version 5.7.99 ; then
	...
	master_status=$(mysql -h node2 -sNe "show master status;")
	sql=$(echo $master_status | awk '{print "change master to master_host=\047node2\047, \
	  master_user=\047repl\047, \
	  master_password=\047repl\047, \
	  master_log_file=\047"$1"\047, " \
	  "master_log_pos="$2";"}')
